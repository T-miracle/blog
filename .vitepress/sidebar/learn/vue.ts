...
const vueItems: DefaultTheme.SidebarItem[] = [
    ...
    { text: '🔥keep-live是什么？如何使用？', link: '/learn/web/vue/what_is_keep-live' },
    {
        ...
        collapsed: false,
        items: [ {
            text: '🔥作用域插槽的使用场景', link: '/learn/web/vue/use_cases_for_scoped_slots'
        } ]
    },
    ...
    { text: '🔥vue项目上线打包时如何做性能优化', link: '/learn/web/vue/vue_project_packaging_optimization' },
    { text: '🔹Vue3 Teleport组件的使用以及适用场景', link: '/learn/web/vue/vue3_teleport' },
    { text: '🔸透传属性（穿透属性）', link: '/learn/web/vue/fallthrough_attributes' },
    { text: '🔸Vue2 在 watch 上使用防抖或节流函数', link: '/learn/web/vue/debounce_or_throttle_function_on_watch' },
    { text: '🔸Vue2 和 Vue3 在双向绑定上的区别', link: '/learn/web/vue/the-difference-between-vue2-and-vue3-in-two-way-binding' },
    { text: '🔸Vue2 组件选项 extends 的用法', link: '/learn/web/vue/component-extends' }
];
