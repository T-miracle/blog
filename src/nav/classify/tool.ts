...
export default [
    ...
    },
    {
        ...
        description: '与你共同构建的AI助手。使用GitHub Copilot，即可在一处生成代码、管理任务并探索你的项目。',
        type: [ '工具', 'AI' ],
        level: 999,
    ...
    },
    {
        ...
        description: 'Gemini 是 Google 开发的一个基于 Transformer 架构的语言模型，能够理解和生成自然语言文本。',
        type: [ '工具', 'AI' ],
        level: 998,
    ...
    {
        name: 'PixPin',
        icon: 'https://pixpinapp.com/logo.png',
